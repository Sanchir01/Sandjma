			...
			<div className={styles.content}>
				<div className={styles.navs}>
					<ul className={styles.catalog}>
						<li className='text-2xl pb-3'>Каталог</li>
						<li>
							<Link to='/Catalog'>Худи</Link>
						</li>
						<li>
							<Link to='/Catalog'>Футболки</Link>
						</li>
						<li>
							<Link to='/Catalog'>Штаны</Link>
						</li>
						<li>
							<Link to='/Catalog'>Панамки</Link>
						</li>
						<li></li>
					</ul>
					<ul className={styles.company}>
						<li className='text-2xl'> О компании</li>
						<li>О бренде</li>
					</ul>
					<nav className={styles.nav__social}>
						...
						<ul className={styles.social}>
							...
							<li>
								{' '}
								<a href='https://vk.com/sandjma' target='_blank'>
									<svg
										className='w-[34px]'
										width='48'
										height='48'
